...
"<<ojcc-java-java-source-file-example,Java源文件示例>>"提供了一个合理组织的Java程序范例。
...
下表描述了类和接口声明的各个项目组以及它们呈现的先后次序。参考"<<ojcc-java-java-source-file-example,Java源文件示例>>"中一个包含注释的例子。
...
*注意：*此处描述的注释组织示例，参考"<<ojcc-java-java-source-file-example,Java源文件示例>>"
