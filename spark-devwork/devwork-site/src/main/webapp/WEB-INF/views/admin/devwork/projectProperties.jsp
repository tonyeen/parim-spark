...
<div class="console-container">
    ...
    <div class="row">
    	<div class="col-sm-12">
    		<form:form id="inputForm" modelAttribute="project" action="${ctxAdmin }/sys/user/save" method="post" class="form-horizontal">
    			<form:hidden path="id"/>
    			...
    			<div class="form-group">
    				...
    				<div class="col-sm-9 row">
    					<form:input path="repoUrl" class="col-lg-5 col-sm-5"/>
    					<span class="help-inline col-lg-7 col-sm-7"></span>
    				</div>
    			</div>
    			<div class="form-group">
    				...
    				<div class="col-sm-9 row">
    					<form:input path="siteUrl" class="col-lg-5 col-sm-5"/>
    					<span class="help-inline col-lg-7 col-sm-7"></span>
    				</div>
    			</div>
    			<div class="form-group">
    				...
    				<div class="col-sm-9 row">
    					<form:password path="category" class="col-lg-5 col-sm-5"/>
    					<span class="help-inline col-lg-7 col-sm-7"></span>
    				</div>
    			</div>
    			<div class="form-group">
